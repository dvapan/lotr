...
помочь ему.`,
        needs: ['Сэм', 'Хоббит']},
    'Страх': {
        info : `Сэм боится потерять Фродо <em>"Я люблю его. Светится он или нет, мне
все равно, я его люблю.ж"</em><p> Сэм меньше всего подвержен влиянию
Кольца, он старается сохранять трезвую голову. Но чем дальше, тем
Кольцо сильнее, и Сэм как и все подвергается искушениям. Слабое место
Сэма - его привязанность к Фродо. Сэм боится, что с ним что-то
случится, ведь Фродо становится все слабее. И этот страх выражен в
отношениях с Голлумом. Сэм ему не доверяет и, в отличие от Фродо, не
может относиться к нему мягче и снисходительнее, тем самым грубость -
это некая форма защиты.`,
        needs: ['Сэм','Кольцо']},
    'Путь': {
        info :`Путь-это одна из центральных величин в Средиземье. Истари приходят в
Средиземье, и тут они предстают в виде ПУТников, Эльфы приходят в
Средиземье, И в данный момент судьба Средиземья зависит от того пути
по которому идут наши герои, от их выбора, и от той цели которую они
перед собой ставят.  Фродо выходит в путь, движимый переживанием
(страхом) за судьбу Шира, он уносит кольцо из Шира, подальше от
Шира.. пока не понимая куда он идёт, но покидает Шир он не один.. с
ним в путешествие отправляется его Сэм..  наставляемый Гендальфом  и эльфами, наши герои проходят каждый свой путь, но так же они
проходят путь друг к другу, меняются их взаимо-отношения.
`,
        needs: ['Фродо','Кольцо']},
    'Прелесть': {
...
личность расколота. Он не принадлежит себе."`,
        needs: ['Голлум','Кольцо']},
    'Клятва/Обещание': {
        info :`Смеагол изначальная личность Голлума. Жизнь Смеагола проистекает из
того же источника, что жизнь всего в Средиземье - от Эру. А вот Голлум
это уже искажение, он возник в результате губительного воздействия
Кольца. Смеагол впервые начинает действовать явно в сцене
клятвы-обещания: «Мы клянемся, да, да. Клянусь! Я буду теперь служить
Хозяину Сокровища. Хозяин хороший. Смеагол тоже хороший». Что же стало
причиной его внезапного появления? К Голлуму проявили жалость, такое
отношение необычно для него. Не исключено, что это доброе отношение и
пробудило Смеагола, и он клянется теперь служить не Кольцу, а его
носителю, Фродо.  <br> В некоторой степени допустимо сказать,что Смеагол
теперь примыкает к братству и в качестве участника отряда вступает в
противоборство с Сауроном. Новый хозяин Кольца - Фродо, добровольно
взял на себя тяжелую миссию противостоять злу в лице владыки Мордора,
чтобы восстановить изначальный порядок, установленный Эру. Пожалуй,
именно на это значение миссии - возвращение к первоисточнику, к жизни
- и откликается лучшая, долго подавлявшаяся личность Смеагола. <br>  Это
интересно: в оригинальном тексте Толкина речь идет не о клятве
(англ. swear), а об обещании (англ. promise). Таким образом, в
некоторых русских переводах сильно искажается смысл этого фрагмента.`,
        needs: ['Жалость','Кольцо']},
    'Предрассудок': {
        info :`<em>"Смотри, береги кастрюли, а то я тебя самого разделаю, как
кролика."</em> - обращается Сэм к Голлуму. Не слишком ли уж грубая
просьба к добытчику желанной крольчатины? Сэм все больше укореняется в
предвзятом отношении к своему провожатому. Мы оцениваем предрассудок
как нечто ложное и вредное, и жесткое отношение Сэма еще раз
подтверждает наше мнение. Однако философия XX века смотрит на
предрассудок совершенно иначе. Без предрассудков невозможно
познание. Благодаря им, вы имеете точки соприкосновения с текстом, что
и делает его понятным для вас.  Однако Сэм хоть и богат
предрассудками, все же не может достичь понимания. Что же не так?
Секрет в том, что предрассудок оправдан, только если в процессе
понимания вы подвергаете его проверке и можете отделить продуктивный
от мешающего. Это нелегко, но оно стоит того, чтобы поучиться. А у
Сэма возьмите пример в чем-то другом, например, в приготовлении
кроликов.`,
        needs: ['Сэм','Голлум']},
    'Молчание': {
...
навык, умение поступать в каждой ситуации наилучшим образом.`,
    ...
    'Преступление': {
        info :`В Голлуме происходит борьба между двумя личностями и пока побеждает
злая. Ради обладания Кольцом он снова готов пойти на убийство -
скормить хоббитов гигантской паучихе Шелоб. Чтобы коварный замысел
сработал, жертвы не должны ничего подозревать.`,
...
function elem_init_controls() {
	...
	$('#reset').click(function(){
		...
		var box = elem_notify(
			'Перезапустить',
			'Щелкини перезапустить, чтобы начать заново.',
			'confirm', options
		);
		$('#notify textarea').focus( function(){ $(this).select(); } );
		$('#notify button').click( function(){ elem_openall_game(); box.close( true ); } );
	...
	$('#load').click(function(){
		...
		var box = elem_notify(
			'Загрузить',
			'Вставте сюда код, который генерируется при сохранении',
			'loadsave', options
		);
		$('#notify textarea').focus( function(){ $(this).select(); } );
	...
	$('#save').click(function(){
		...
		var box = elem_notify(
			'Сохраните вашу игру',
			"Вот код для сохранения вашей игры. Запишите его или отправьте себе по почте! (Также прогресс сохраняется в cookies)",
			'loadsave', options
		);
		$('#notify textarea').focus( function(){ $(this).select(); } );
